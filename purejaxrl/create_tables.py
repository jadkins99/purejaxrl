...
dbase.execute("CREATE TABLE IF NOT EXISTS sweep_runs (env_name TEXT, alg_type TEXT, gae_lambda REAL,  critic_lr REAL, actor_lr REAL, ent_coef REAL, T INTEGER, seed_idx INTEGER, mean_episode_return REAL);"
)
dbase.commit()
